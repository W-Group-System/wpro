                    ...
                    <div class="card-body">
                        ...
                        <p class="card-description">
                          @if (checkUserPrivilege('settings_add',auth()->user()->id) == 'yes')
                            <button type="button" class="btn btn-outline-warning btn-icon-text" data-toggle="modal" data-target="#uploadModal">
                              <i class="ti-plus btn-icon-prepend"></i>                                                    
                              Upload
                            </button>
                            <button class="btn btn-outline-success btn-icon-text" data-toggle="modal" data-target="#exportModal">
                              <i class="ti-plus btn-icon-prepend"></i>                                                    
                              Export Template
                            </button>
                          @endif
