<div class="modal fade" id="edit_time-{{$overtime->id}}" tabindex="-1" role="dialog" aria-labelledby="approveOTHrs" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method='POST' action='timekeeper-approve-ot-hrs/{{$overtime->id}}' onsubmit='show()' enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class='col-md-12 form-group'>
                            ...
                            @endphp
                            <input id="approve_hrs" type="number" name='ot_approved_hrs' value='{{ $approve_hrs }}'  step='0.01' class="form-control" required>
                        </div>
                        <div class='col-md-12 form-group'>
