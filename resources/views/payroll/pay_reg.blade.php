                      ...
                      <tbody>
                        ...
                        @endphp
                          ...
                          @php
                              ...
                              $total_ot_pay = $total_lh_ot+$total_lh_ot_over_eight+$total_reg_ot+$total_reg_ot_nd+$total_rst_ot+$total_rst_ot_over_eight+$total_rst_nd+$total_rst_nd_over_eight+$total_lh_nd_amount+$total_lh_nd_over_eight+$total_reg_nd+$total_sh_nd_amount+$total_sh_nd_over_eight+$total_sh_ot+$total_sh_ot_over_eight+$total_rst_sh_ot_over_eight+$total_rst_sh_ot+$total_rst_lh_ot+$total_rst_lh_ot_over_eight+$total_rst_lh_nd+$total_rst_lh_nd_over_eight;
                              ...
                              if($payroll_b)
                              {
                                ...
                                // added other allowance adjustment
                                    $other_allowance_adjustment = ($last_c->pay_instructions)->where('payreg_id', $last_c->id)->where('instruction_name', 'Other Allowance Adjustment')->sum('amount');

                                  $lastccc = $last_c->gross_taxable_income-$last_c->absent_amount-$last_c->tardiness_amount-abs($de_minimis_deduction)-$last_c->undertime_amount+$last_c->deminimis+$last_c->other_allowances_basic_pay+$last_c->subliq+$de_minimis_adjustment+$other_allowance_adjustment;
                                  // dd($government_amount);
                                //   dd($last_c);
                                  // if($name->employee->employee_code == "A368423")
                                  // {
                                  //   $lastccc = $lastccc + $last_c->ot_total;
                                  // }
