                          ...
                          @php
                              ...
                              if($payroll_b)
                              {
                                ...
                                //   dd($de_minimis_deduction);
                                  ...
                                  $lastccc = $last_c->gross_taxable_income-$last_c->absent_amount-$last_c->tardiness_amount-abs($de_minimis_deduction)-$last_c->undertime_amount+$last_c->deminimis+$last_c->other_allowances_basic_pay+$last_c->subliq+$de_minimis_adjustment+$last_c->ot_total;
