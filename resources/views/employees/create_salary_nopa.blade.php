<div class="modal fade" id="createSalaryNopa" tabindex="-1" role="dialog" aria-labelledby="createSalaryNopaInfoLabel" aria-hidden="true">
	<div class="modal-dialog modal-xl" role="document">
		<div class="modal-content">
			...
			<form method='POST' action='updateEmpSalaryMovementHR/{{ $user->employee->employee_salary->id }}' onsubmit='show()' enctype="multipart/form-data">
				@csrf
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class='col-md-12'>
                                                        <input id="basic_salary_from" class="form-control" type="text" name="basic_salary_from" value="{{$user->employee->employee_salary->basic_salary}}" readonly>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class='col-md-12'>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class='col-md-12'>
                                                        <input id="de_minimis_from" class="form-control" type="text" name="de_minimis_from" value="{{$user->employee->employee_salary->de_minimis}}" readonly>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class='col-md-12'>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class='col-md-12'>
                                                        <input id="other_allowance_from" class="form-control" type="text" name="other_allowance_from" value="{{$user->employee->employee_salary->other_allowance}}" readonly>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class='col-md-12'>
