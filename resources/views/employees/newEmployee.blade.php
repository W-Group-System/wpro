            ...
            <div class="col-md-12 mx-0">
              <form id="msform" class='text-center' method='post' onsubmit='show()' action='{{url('/new-employee')}}' enctype="multipart/form-data">
                ...
                <ul id="progressbar">
                  ...
                  <li id="payment"><strong>Government & Documents</strong></li>
                  ...
                  <div class="form-card">
                    ...
                    <div class='row mb-2'>
                      ...
                      <div class='col-md-2'>
                        ...
                        <select data-placeholder="Marital Status" class="form-control form-control-sm required js-example-basic-single" style='width:100%;' name='marital_status' required>
                      ...
                      <div class='col-md-2'>
                        <span>Gender</span>
                        <select data-placeholder="Gender" class="form-control form-control-sm required js-example-basic-single" style='width:100%;' name='gender' required>
                    ...
                    <div class="row mb-2">
                      ...
                      <div class="col-md-3"> 
                        Birth Place 
                        <input type="text" name="birthplace" class='form-control form-control-sm required'placeholder="BIRTHPLACE"/>
                      </div>
                    </div>
                    <hr>
