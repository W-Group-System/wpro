    ...
    public function collection(Collection $collection)
    {
        ...
        foreach ($rows as $row) {
            ...
            $dailySchedules[] = [
                ...
                'log_date' => $row['log_date'] != null ? Date::excelToDateTimeObject($row['log_date'])->format('Y-m-d') : null,
                'time_in_from' => $row['time_in_from'] != null ? Date::excelToDateTimeObject($row['time_in_from'])->format('H:i') : null,
                'time_in_to' => $row['time_in_to'] != null ? Date::excelToDateTimeObject($row['time_in_to'])->format('H:i') : null,
                'time_out_from' => $row['time_out_from'] != null ? Date::excelToDateTimeObject($row['time_out_from'])->format('H:i') : null,
                'time_out_to' => $row['time_out_to'] != null ? Date::excelToDateTimeObject($row['time_out_to'])->format('H:i') : null,
