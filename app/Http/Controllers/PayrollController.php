...
class PayrollController extends Controller
{
    ...
    public function payroll_report(Request $request)
    {
        ...
        SUM(rst_lh_ot) as rst_lh_ot,
        SUM(rst_lh_ot_amount) as rst_lh_ot_amount,
        SUM(rst_lh_ge_ot) as rst_lh_ge_ot,
        SUM(rst_lh_ge_ot_amount) as rst_lh_ge_ot_amount,
        SUM(rst_lh_nd) as rst_lh_nd,
        SUM(rst_lh_nd_amount) as rst_lh_nd_amount,
        SUM(rst_lh_ge_nd) as rst_lh_ge_nd,
        SUM(rst_lh_ge_nd_amount) as rst_lh_ge_nd_amount,
