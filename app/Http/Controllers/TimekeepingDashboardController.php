...
class TimekeepingDashboardController extends Controller
{
    ...
    public function timekeepingOfficial(Request $request)
    {
        ...
        $employees = Employee::select('id','user_id','employee_code','first_name','last_name','schedule_id','employee_number','company_id','department_id','work_description')
            ->with(['schedule_info','company'])
            ->with([
            ...
            ->with([
                'dtr_correction' => function($q) use($date_from, $to_date) {
